...
.method private cleanupUpstream()V
    ...
    invoke-static {v1}, Lcom/android/server/connectivity/Tethering;->access$2600(Lcom/android/server/connectivity/Tethering;)Landroid/net/INetworkStatsService;
...
.method public enter()V
    ...
    invoke-virtual {v2}, Lcom/android/server/connectivity/Tethering;->isDunApnExist()Z

    move-result v2

    #setter for: Lcom/android/server/connectivity/Tethering;->mDunApnExist:Z
    invoke-static {v1, v2}, Lcom/android/server/connectivity/Tethering;->access$2302(Lcom/android/server/connectivity/Tethering;Z)Z
    ...
    invoke-virtual {v1}, Lcom/android/server/connectivity/Tethering;->updateConfiguration()V
    ...
    #getter for: Lcom/android/server/connectivity/Tethering;->mLp:Landroid/net/LinkProperties;
    invoke-static {v2}, Lcom/android/server/connectivity/Tethering;->access$2400(Lcom/android/server/connectivity/Tethering;)Landroid/net/LinkProperties;
    ...
    #getter for: Lcom/android/server/connectivity/Tethering;->mTableId:I
    invoke-static {v3}, Lcom/android/server/connectivity/Tethering;->access$2500(Lcom/android/server/connectivity/Tethering;)I

    move-result v3

    invoke-virtual {v1, v2, v3}, Lcom/android/server/connectivity/Tethering;->updateTetherRoute(Landroid/net/LinkProperties;I)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v6, v7}, Lcom/android/server/connectivity/Tethering;->access$2900(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;)[Landroid/net/LinkAddress;
    ...
    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v5, v6}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$3000(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;Lcom/android/internal/util/IState;)V
    ...
    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v5, v6}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$3100(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;Lcom/android/internal/util/IState;)V
